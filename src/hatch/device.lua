...
function Device.parseState(reported)
  ...
  -- Takes both signals. `playing` is shared with the light, so light-on sets
  -- playing="remote" with no sound and would fake a "Sound 19998" session; and
  -- the Restore keeps its last soundId when idle, so the id alone leaves it
  -- stuck "playing".
